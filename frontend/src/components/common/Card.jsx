...
function Card({ title, Icon, number, subtitle }) {
  return (
    <div className="bg-white border border-zinc-300  rounded-xl p-4 shadow-sm hover:shadow-lg flex flex-col justify-between font-poppins text-midnight flex-wrap flex-1 transition-transform duration-150 ease-in-out hover:scale-105 gap-2">
